-- 🧪 [Migration] [2026-08-02] إصلاح ترحيل سداد مقدم أو مبالغ مخصصة تحت الحساب للمريض
-- الغرض: تمكين دالة hims_finalize_billing من معالجة المعامل p_custom_amount (المبلغ المقبوض الفعلي)
-- وترحيله بشكل كامل إلى الخزينة/الصندوق، وإثبات الفرق كرصيد دائن للمريض في حسابه (ذمم العملاء) للعمليات المستقبلية.
