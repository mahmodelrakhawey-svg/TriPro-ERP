-- Migration: Fix scrap stock recalculation in recalculate_stock_rpc function
-- Reason: Include mfg_scrap_logs in stock recalculations to prevent scrap quantities from being ignored.
