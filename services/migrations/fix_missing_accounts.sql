...
BEGIN
    ...
    v_accounts := ARRAY[
        ...
        ROW('11192', 'مجمع إهلاك المباني والإنشاءات', 'ASSET', false, '111'),
        ROW('11193', 'مجمع إهلاك الآلات والمعدات', 'ASSET', false, '111'),
        ROW('11194', 'مجمع إهلاك وسائل النقل والانتقال (السيارات)', 'ASSET', false, '111'),
        ROW('11195', 'مجمع إهلاك الأثاث والتجهيزات المكتبية', 'ASSET', false, '111'),
        ROW('11196', 'مجمع إهلاك أجهزة حاسب آلي وبرمجيات', 'ASSET', false, '111'),
        ROW('112', 'استثمارات مالية', 'ASSET', false, '11'),
        ROW('113', 'قروض ممنوحة للغير', 'ASSET', false, '11'),
        ROW('118', 'أصول غير ملموسة', 'ASSET', true, '11'),
        ROW('1181', 'مصاريف تأسيس', 'ASSET', false, '118'),
        ...
        ROW('1224', 'عهد موظفين', 'ASSET', false, '122'),
        ROW('1225', 'مخصص ديون مشكوك فيها', 'ASSET', false, '122'),
        ROW('1226', 'مخصص أجيوم', 'ASSET', false, '122'),
        ROW('1227', 'مخصص خصم مسموح به', 'ASSET', false, '122'),
        ...
        -- الخصوم
        ROW('211', 'قروض طويلة الأجل', 'LIABILITY', false, '21'),
        ROW('212', 'قرض السندات', 'LIABILITY', false, '21'),
        ...
        ROW('424', 'إيراد استثمارات', 'REVENUE', false, '42'),
        ...
        ROW('5342', 'مصروف فائدة قرض السندات', 'EXPENSE', false, '53'),
