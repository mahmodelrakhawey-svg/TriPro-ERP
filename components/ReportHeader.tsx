...
const ReportHeader: React.FC<ReportHeaderProps> = ({ title, subtitle }) => {
  ...
  return (
    <div className="p-8 border-b border-slate-100 flex justify-between items-start print:p-4 bg-white">
      {/* إضافة اللوجو في الترويسة إذا وجد */}
      {settings.logoUrl && (
      ...
      <div className="text-left">
        {title && <h2 className="text-xl font-bold text-slate-800 text-emerald-600">{title}</h2>}
