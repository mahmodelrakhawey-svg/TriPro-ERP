...
const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { to: '/income-statement', label: 'قائمة الدخل الشامل (IFRS 18)', icon: TrendingUp, color: 'text-cyan-400', module: 'accounting', permission: 'accounting.view' },
    { to: '/balance-sheet', label: 'قائمة المركز المالي (الميزانية)', icon: BarChart3, color: 'text-cyan-400', module: 'accounting', permission: 'accounting.view' },
    { to: '/changes-in-equity', label: 'قائمة التغير في حقوق الملكية', icon: Scale, color: 'text-cyan-400', module: 'accounting', permission: 'accounting.view' },
    { to: '/cash-flow', label: 'قائمة التدفقات النقدية (IAS 7)', icon: Activity, color: 'text-cyan-400', module: 'accounting', permission: 'accounting.view' },
    { to: '/annual-report', label: 'كتاب التقرير المالي السنوي (IAS 1)', icon: BookOpen, color: 'text-indigo-400', module: 'accounting', permission: 'accounting.view' },
    { to: '/cfo-dashboard', label: 'لوحة قيادة المدير المالي (CFO)', icon: Activity, color: 'text-cyan-400', module: 'accounting', permission: 'accounting.view' },
    ...
    { to: '/fiscal-year-closing', label: 'معالج التسويات وإقفال السنة المالية', icon: Lock, color: 'text-cyan-400', module: 'accounting', permission: 'accounting.post' },
