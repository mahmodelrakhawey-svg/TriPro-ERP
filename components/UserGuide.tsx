...
const UserGuide = () => {
  ...
  const filteredTopics = useMemo(() => {
    return guideTopics.filter(topic => {
      ...
      return matchTitle || matchSummary || matchKeywords || matchSteps || matchTips;
    });
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white rounded-[36px] p-8 md:p-12 shadow-2xl border border-indigo-500/20">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-slate-300 text-sm md:text-base leading-relaxed">
            شرح تفصيلي معتمد لكافة الموديولات المالية، التجارية، الصناعية، والطبية مع أفضل الممارسات المحاسبية.
          </p>
          ...
          <div className="relative max-w-2xl mx-auto pt-2">
            ...
            <input
              type="text"
              placeholder="ابحث عن أي عملية (فاتورة إلكترونية، شيكات، جرد، مستخلصات، صلاحيات، ترحيل، WAC)..."
              value={searchTerm}
        ...
        <div className="relative z-10 flex flex-wrap items-center justify-between gap-4 mt-8 pt-8 border-t border-white/10 text-xs">
          <div className="flex items-center gap-4 text-slate-300 font-medium">
            ...
            <span className="flex items-center gap-1.5"><ShieldCheck size={14} className="text-indigo-400" /> معتمد محاسبياً وضريبياً</span>
          </div>
                  ...
                  <div className="p-6 md:p-8 pt-2 border-t border-slate-100 bg-slate-50/50 space-y-6 animate-in slide-in-from-top-2">
                    ...
                    {topic.linkPath && (
                      <div className="pt-2 flex justify-end">
                        ...
                        >
                          <span>الانتقال إلى شاشة الموديول الآن</span>
                          <ArrowRight size={15} />
                        </Link>
                      </div>
                    )}
