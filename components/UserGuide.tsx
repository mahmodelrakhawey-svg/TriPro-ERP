...
const guideTopics: GuideTopic[] = [
  ...
  },
  {
    ...
    summary: 'دورة المبيعات الشاملة، عروض الأسعار، نقاط البيع، الربط اللحظي مع مصلحة الضرائب المصرية والتوقيع المحلي، وهيئة الزكاة (ZATCA Phase 2).',
    keywords: ['مبيعات', 'فواتير', 'عملاء', 'عروض أسعار', 'ضرائب', 'فاتورة إلكترونية', 'ZATCA', 'ETA', 'QR Code', 'USB Token', 'توقيع'],
    linkPath: '/eta-invoices',
    quickLinks: [
      { label: 'مركز الفاتورة والإيصال الإلكتروني (ETA Hub)', path: '/eta-invoices' },
      ...
      { label: 'إعدادات الضرائب والمساعد المحلي', path: '/settings' }
    ],
    steps: [
      ...
      'مركز الفاتورة الإلكترونية (ETA Hub): إرسال الفواتير الفردي أو الجماعي للضرائب واستلام رمز الاستجابة السريعة ومعرف الـ UUID الرسمي.',
      'التوقيع الإلكتروني المحلي (USB Token Signer): تشغيل أداة start-signer.bat على جهاز المحاسب للتوقيع الحي عبر فلاشات Egypt Trust ومصر للمقاصة على المنفذ 8500.',
      'الفوترة الإلكترونية السعودية (ZATCA Phase 2): ختم الفواتير برمز الاستجابة السريعة المعتمد (Cryptographic TLV Base64).',
      'مرتجعات المبيعات (Credit Notes): إصدار إشعار دائن وتسوية التأثير المالي ورصيد المخزون فوراً.'
    ],
    tips: [
      'يمكنك تتبع الفواتير المرفوضة من مصلحة الضرائب وفحص سبب الرفض الدقيق بنقرة واحدة من مركز الفاتورة الإلكترونية.'
    ],
    warnings: [
  ...
  },
  {
    ...
    steps: [
      'العمل دون اتصال بالإنترنت (Offline Mode): تعمل نقطة البيع بكامل طاقتها لإصدار الفواتير وطباعة الإيصالات عند انقطاع الإنترنت.',
      'محرك المزامنة التلقائية (Batch Sync Engine): فور عودة الإنترنت، يرفع النظام دفعات الطلبات المعلقة آلياً بحد أقصى 20 طلباً لكل دفعة.',
      'فض التعارضات الذكي (Conflict Resolution): عند حدوث عجز في المخزون أثناء البيع أوفلاين، يعتمد النظام العملية ويسجل الرصيد بالسالب مع إرسال إشعار فوري لمدير الفرع.',
      'فتح وإغلاق الشفت: تسجيل الرصيد الافتتاحي للعهدة، وتوريد النقدية ومطابقة العجز (541) والزيادة (441) عند الإغلاق.',
  ...
  },
  {
    ...
    category: 'admin',
    title: '🔄 إدارة المنصة السحابية والنسخ الاحتياطي وترحيل البيانات',
    badge: 'SaaS & Backups',
    icon: Database,
    color: 'from-indigo-600 to-purple-800',
    summary: 'إدارة المنظمات والاشتراكات، النسخ الاحتياطي السحابي التلقائي (3:00 ص)، واستيراد وتصدير البيانات دون الحاجة لأي أوامر SQL.',
    keywords: ['saas', 'استيراد', 'ترحيل بيانات', 'سلة المحذوفات', 'نسخ احتياطي', 'استعادة', 'Excel', 'JSON', 'سحابي'],
    linkPath: '/saas-admin',
    quickLinks: [
      { label: 'بوابة إدارة المنصة (SaaS Admin)', path: '/saas-admin' },
      { label: 'مركز ترحيل واستيراد البيانات', path: '/data-migration' },
      { label: 'سلة المحذوفات الآمنة', path: '/recycle-bin' },
      { label: 'النسخ الاحتياطي السحابي والمحلي', path: '/settings' }
    ],
    steps: [
      'بوابة إدارة المنصة (SaaS Admin): إدارة شاملة للشركات والاشتراكات والموديولات بتبويبات واضحة دون فتح قاعدة البيانات.',
      'النسخ الاحتياطي الآلي اليومي: يقوم النظام بجدولة نسخة سحابية يومياً الساعة 3:00 صباحاً مع الاحتفاظ تلقائياً بآخر نسختين.',
      'إنشاء واستعادة النسخ بنقرة واحدة: أخذ نسخة كاملة فورية وتنزيلها كملف JSON، أو استعادتها سحابياً بكلمة تأكيد أمنية مشددة.',
      'مركز ترحيل البيانات: استيراد الأصناف، العملاء، والموردين، والأرصدة الافتتاحية من ملفات Excel جاهزة.',
      'سلة المحذوفات (Recycle Bin): إمكانية استرجاع أي مستند أو قيد تم حذفه بالخطأ بنقرة زر واحدة.'
    ]
  }
];
