...
export const ReceiptVoucherPrint: React.FC<ReceiptVoucherPrintProps> = ({ voucher, companySettings }) => {
    ...
    <div className="hidden print:block p-8 bg-white text-black rtl w-full" dir="rtl">
      ...
      <div className="flex justify-between items-center border-b-2 border-slate-800 pb-4 mb-6">
        <div className="text-right">
          <h1 className="text-2xl font-black">{companySettings?.company_name || companySettings?.companyName || 'سند قبض'}</h1>
