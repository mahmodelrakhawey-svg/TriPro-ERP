...
export const ReceiptVoucherPrint = ({ voucher, companySettings }: ReceiptVoucherPrintProps) => {
    ...
    <div className="hidden print:block fixed inset-0 bg-white z-[9999] p-8 text-black font-sans" dir="rtl" id="printable-voucher">
      ...
      <div className="flex justify-between items-start border-b-2 border-slate-800 pb-6 mb-8">
        ...
        <div className="text-center">
            <h1 className="text-3xl font-black text-slate-900 mb-2">سند قبض</h1>
            <p className="text-lg font-bold text-slate-500 uppercase tracking-widest">Receipt Voucher</p>
        </div>
      ...
      <div className="flex justify-between mb-8">
        <div className="flex gap-4">
            ...
            <div className="bg-slate-100 px-4 py-2 rounded border border-slate-200">
                ...
                <span className="text-xl font-bold">{voucher.receipt_date}</span>
            </div>
        </div>
      ...
      <div className="border border-slate-300 rounded-lg p-6 space-y-6 mb-12">
        <div className="flex items-baseline gap-4">
            ...
            <div className="flex-1 border-b border-dotted border-slate-400 pb-1 font-bold text-lg">{voucher.customers?.name || '---'}</div>
        </div>
