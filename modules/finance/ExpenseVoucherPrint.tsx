...
export const ExpenseVoucherPrint = ({ voucher, companySettings }: ExpenseVoucherPrintProps) => {
    ...
    <div className="hidden print:block fixed inset-0 bg-white z-[9999] p-8 text-black font-sans" dir="rtl" id="printable-voucher">
      ...
      <div className="flex justify-between items-start border-b-2 border-slate-800 pb-6 mb-8">
        ...
        <div className="text-center">
            <h1 className="text-3xl font-black text-slate-900 mb-2">سند صرف مصروف</h1>
            <p className="text-lg font-bold text-slate-500 uppercase tracking-widest">Expense Voucher</p>
        </div>
      ...
      <div className="border border-slate-300 rounded-lg p-6 space-y-6 mb-12">
        <div className="flex items-baseline gap-4">
            <span className="font-bold text-slate-700 w-32 shrink-0">حساب المصروف:</span>
