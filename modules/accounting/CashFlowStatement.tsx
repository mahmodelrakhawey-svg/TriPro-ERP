    ...
    try {
      ...
      accounts.forEach(acc => {
        ...
        const isCash = type.includes('cash') || type.includes('bank') || 
                       ...
                       code.startsWith('1101') || code.startsWith('101') || code.startsWith('102');
      ...
      const cashAccountIds = accounts.filter(acc => {
          ...
          return code.startsWith('1101') || code.startsWith('101') || code.startsWith('102') || name.includes('صندوق') || name.includes('بنك') || name.includes('نقد');
      }).map(a => a.id);
