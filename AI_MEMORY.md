...
> ⚠️ **قاعدة بيئة التطوير المعزولة (قاعدة بيانات):**
> نحن نعمل في بيئة تطوير معزولة. أي تعديلات تخص جداول أو دوال قاعدة البيانات لا تطبقها مباشرة، بل ضع كود الـ SQL الخاص بها في ملف مستقل داخل مجلد `sql_updates` يبدأ بتاريخ اليوم واسم الميزة (مثال: `YYYY-MM-DD_feature_name.sql`).
