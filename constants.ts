...
export const INITIAL_ACCOUNTS: Omit<Account, 'id' | 'balance'>[] = [
  ...
  { code: '1204', name: 'أوراق القبض (شيكات)', type: AccountType.ASSET, is_group: false, parent_account: '102', is_active: true },
  { code: '10203', name: 'سلف الموظفين', type: AccountType.ASSET, is_group: false, parent_account: '102', is_active: true },
  { code: '1209', name: 'عهد موظفين', type: AccountType.ASSET, is_group: false, parent_account: '102', is_active: true },
  ...
  { code: '1399', name: 'مجمع الإهلاك', type: AccountType.ASSET, is_group: false, parent_account: '11', is_active: true }, // يظهر بالسالب عادة
  ...
  { code: '2202', name: 'أوراق الدفع', type: AccountType.LIABILITY, is_group: false, parent_account: '2', is_active: true },
  ...
  { code: '3103', name: 'الأرباح المبقاة', type: AccountType.EQUITY, is_group: false, parent_account: '3', is_active: true },
  ...
  { code: '4102', name: 'خصم مسموح به', type: AccountType.REVENUE, is_group: false, parent_account: '4', is_active: true }, // يخصم من الإيراد
  ...
  { code: '5201', name: 'الرواتب والأجور', type: AccountType.EXPENSE, is_group: false, parent_account: '5', is_active: true },
  ...
  { code: '5202', name: 'مصروف الإهلاك', type: AccountType.EXPENSE, is_group: false, parent_account: '5', is_active: true },
  ...
  { code: '515', name: 'مصروفات مكتبية', type: AccountType.EXPENSE, is_group: false, parent_account: '5', is_active: true },
];
